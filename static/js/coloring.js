...
function download_image() {
    var canvas = document.getElementById("paintid");
    image = canvas.toDataURL("image/svg", 1.0).replace("image/svg", "image/octet-stream");
...
$('#download').click(function(){
  var link1 = document.getElementById("paintid")
  image = link1.toDataURL("image/svg", 1.0).replace("image/svg", "image/octet-stream");
  var link = document.createElement('a');
  link.href = image;
  link.click();
